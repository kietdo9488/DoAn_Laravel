        ...
        <nav id="sidebar" class="sidebar js-sidebar">
            <div class="sidebar-content js-simplebar">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item active">
                        <a class="sidebar-link" href="{{ route('manage-product') }}">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('home') }}">
                            <i class="align-middle" data-feather="log-in"></i> <span class="align-middle">Home</span>
                        </a>
                    </li>

                    <li class="sidebar-item">
                        <a class="sidebar-link" href="pages-sign-up.html">
                            <i class="align-middle" data-feather="user-plus"></i> <span class="align-middle"></span>
                ...
                <tbody class="table-group-divider">
                    @foreach ($productList as $item)
                        <tr>
                            <th>{{ $item['id'] }}</th>
                            <td>
                                <img src="img/{{ $item['product_photo'] }}" style="width: 100px; height: 100px;"
                                    alt="">
                            </td>
                            ...
                            <td>
                                ...
                                <form method="POST" action="{{ route('delete-product', ['id' => $item->id]) }}"
